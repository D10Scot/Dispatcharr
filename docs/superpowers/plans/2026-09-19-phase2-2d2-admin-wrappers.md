...
- **The spec's A10.11** (`:3344`) — the seven `relay_client` call sites move from `apps/proxy/live_proxy/views.py:1009, :1107, :1114, :1159, :1206, :1261, :1343` to `apps/proxy/ts_admin_views.py:166, :264, :271, :316, :363, :421, :503`. Both lists were verified line by line at the seed and on the finished shape.
